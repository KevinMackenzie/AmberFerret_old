...
namespace Pencil.Gaming.Scripting {
	public static unsafe partial class Lua {
		...
		public static string PushLString(LuaStatePtr l, string s) {
			return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaDelegates.lua_pushlstring(l, s, s.Length));
		}
		...
		public static string GetLocal(LuaStatePtr l, LuaDebugPtr ar, int n) {
			return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaDelegates.lua_getlocal(l, ar, n));
		}
		public static string SetLocal(LuaStatePtr l, LuaDebugPtr ar, int n) {
			return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaDelegates.lua_setlocal(l, ar, n));
		}
		public static string GetUpValue(LuaStatePtr l, int funcindex, int n) {
			return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaDelegates.lua_getupvalue(l, funcindex, n));
		}
		public static string SetUpValue(LuaStatePtr l, int funcindex, int n) {
			return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaDelegates.lua_setupvalue(l, funcindex, n));
		}
