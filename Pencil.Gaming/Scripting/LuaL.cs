...
namespace Pencil.Gaming.Scripting {
	public static unsafe partial class LuaL {
		...
		public static string ToLString(LuaStatePtr l, int idx, out int len) {
			fixed(int * i = &len) {
				return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaLDelegates.luaL_tolstring(l, idx, i));
			}
		}
		...
		public static string CheckLString(LuaStatePtr l, int numArg, out int l_) {
			fixed (int * i = &l_) {
				return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaLDelegates.luaL_checklstring(l, numArg, i));
			}
		}
		public static string OptLString(LuaStatePtr l, int numArg, string def, out int l_) {
			fixed (int * i = &l_) {
				return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaLDelegates.luaL_optlstring(l, numArg, def, i));
			}
		}
		...
		public static string GSub(LuaStatePtr l, string s, string p, string r) {
			return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaLDelegates.luaL_gsub(l, s, p, r));
		}
