...
//		}
		...
		public static string CheckString(LuaStatePtr l, int n) {
			return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaLDelegates.luaL_checklstring(l, n, null));
		}

		public static string OptString(LuaStatePtr l, int n, string d) {
			return dotnetCoreWorkaround.dotnetCoreUtils.sbyteToString(LuaLDelegates.luaL_optlstring(l, n, d, null));
		}
